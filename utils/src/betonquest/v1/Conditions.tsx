    ...
    static updateKinds() {
        this.kinds = [
            ...
            // Citizens - https://betonquest.org/1.12/User-Documentation/Compatibility/#npc-distance-npcdistance
            {
                ...
                argumentsPatterns: {
                    mandatory: [
                        { jsx: Number, name: L("betonquest.v1.condition.npcdistance.mandatory.npcID.name"), type: ArgumentType.string, format: 'int', defaultValue: 0, tooltip: L("betonquest.v1.condition.npcdistance.mandatory.npcID.tooltip"), config: { min: 0 } },
            ...
            },
            {
                ...
                argumentsPatterns: {
                    mandatory: [
                        { jsx: Number, name: L("betonquest.v1.condition.npclocation.mandatory.npcID.name"), type: ArgumentType.string, format: 'int', defaultValue: 0, tooltip: L("betonquest.v1.condition.npclocation.mandatory.npcID.tooltip"), config: { min: 0 } },
            ...
            },
            {
                ...
                argumentsPatterns: {
                    mandatory: [
                        { jsx: Number, name: L("betonquest.v1.condition.npcregion.mandatory.npcID.name"), type: ArgumentType.string, format: 'int', defaultValue: 0, tooltip: L("betonquest.v1.condition.npcregion.mandatory.npcID.tooltip"), config: { min: 0 } },
