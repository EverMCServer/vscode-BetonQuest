    ...
    static updateKinds() {
        this.kinds = ([
            ...
            // Citizens - https://betonquest.org/2.1/Documentation/Scripting/Building-Blocks/Integration-List/#citizens
            {
                ...
                argumentsPatterns: {
                    mandatory: [
                        { jsx: Number, name: L("betonquest.v2.event.movenpc.mandatory.npcID.name"), type: ArgumentType.interger, format: 'int', defaultValue: 0, tooltip: L("betonquest.v2.event.movenpc.mandatory.npcID.tooltip"), config: { allowedPatterns: [/^\S*$/] } },
            ...
            },
            {
                ...
                argumentsPatterns: {
                    mandatory: [
                        { jsx: Number, name: L("betonquest.v2.event.stopnpc.mandatory.npcID.name"), type: ArgumentType.interger, format: 'int', defaultValue: 0, tooltip: L("betonquest.v2.event.stopnpc.mandatory.npcID.tooltip"), config: { min: 0 } },
                    ],
                }
            },
            {
                ...
                argumentsPatterns: {
                    mandatory: [
                        { jsx: Number, name: L("betonquest.v2.event.teleportnpc.mandatory.npcID.name"), type: ArgumentType.interger, format: 'int', defaultValue: 0, tooltip: L("betonquest.v2.event.teleportnpc.mandatory.npcID.tooltip"), config: { min: 0 } },
