...
export class ConditionsEditorProvider implements vscode.CustomTextEditorProvider {
    ...
    public static register(context: vscode.ExtensionContext): vscode.Disposable {
        const provider = new ConditionsEditorProvider(context);
    ...
    public async resolveCustomTextEditor(
        ...
        // Hook up condition handlers so that we can synchronize the webview with the text document.
        //
    ...
    private getWebviewContent(webview: vscode.Webview, document: vscode.TextDocument): string {
        ...
        const reactAppPathOnDisk = vscode.Uri.joinPath(this.context.extensionUri, "dist", "conditionsEditor.js");
