    ...
    },
    {
        ...
        argumentsPattern: {
            mandatory: [
                ...
                { jsx: InputList, name: L("betonquest.v1.condition.party.mandatory.conditionNames.name"), type: 'string[,]', placeholder: '(none)', defaultValue: ['a_condition_1'], tooltip: L("betonquest.v1.condition.party.mandatory.conditionNames.tooltip"), config: { allowedPatterns: [/^\S*$/] } },
            ],
            optional: [
