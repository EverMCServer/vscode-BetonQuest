import { Diagnostic, DiagnosticSeverity, CompletionItem, CompletionItemKind } from "vscode-languageserver";
...
export abstract class AbstractTagName<T extends NodeType> extends AbstractID<T> {
