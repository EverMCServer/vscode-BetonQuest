...
import { ConversationEventsType, ConversationOptionType, AbstractNodeV2 } from "../../../node";
...
export class Events<PT extends AbstractNodeV2<ConversationOptionType>> extends AbstractNodeV2<ConversationEventsType> {
