...
import { ConversationOptionType, ConversationPointerType, NodeType, NodeV1 } from "../../../node";
import { Pointers } from "./Pointers";

export class Pointer<T extends ConversationOptionType> extends NodeV1<NodeType> {
